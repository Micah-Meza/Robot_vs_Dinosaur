...
# (instances of those classes) to interact with each other, create 
# a console application that will have a robot and a dinosaur fight 
# in a battle.
...
# (5 points): As a developer, I want to make at least 
# 7 commits with good, descriptive messages.

# (5 points): As a developer, I want to make a class 
# for each of the following: Robot, Dinosaur, Weapon, 
# Battlefield.
...
# (10 points): As a developer, I want the battle to conclude 
# once either the robot or the dinosaur has its health points 
# reduced to zero.
...
# (5 points): As a developer, I want to create Fleet and Herd 
# classes, allowing for a list of 3 Robots to battle against a 
# list of 3 Dinosaurs.
